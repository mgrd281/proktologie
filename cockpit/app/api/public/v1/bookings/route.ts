...
import { PublicError, createPublicBooking } from "@/lib/booking/public";
...
export async function POST(req: Request) {
  ...
  try {
    const r = await createPublicBooking(body, clientIp(req));
    // Bestätigungs-Mail zügig raus – der Tick läuft nach der Antwort, gedrosselt
    void maybeTickSoon();
