...
test("gültige Antwort: Zustand übernommen, Aufruf ohne Cookies und ohne Cache", async () => {
  ...
  assert.deepEqual(r, { bookingLive: true, bookingPaused: true, banner: "Geschlossen.", chatEnabled: true });
...
test("leeres Banner wird zu null", async () => {
  ...
  assert.deepEqual(r, { bookingLive: false, bookingPaused: false, banner: null, chatEnabled: true });
});
